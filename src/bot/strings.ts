...
Відправте повідомлення по цьому шаблону:\n
{
    ...
    unitApproved: (otp: string) => `Ваш підрозділ було зареєстровано.\nВикористайте цей код, для першого входу в додаток: ${otp}.\nТам ви зможете додати інформацію та опублікувати його.`,
    unitNewOtpGenerated: (otp: string) => `Використайте цей код, як під час першого входу в додаток: ${otp}`,
    unitYourOtp: (otp: string) => `Ваш одноразовий пароль для першого входу в додаток: ${otp}`,
